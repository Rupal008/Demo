    ...
    <div>
      ...
      <div class="mt-[10%]">
        <div class="lg:p-16 lg:w-[60%] min-[250px]:p-5">
          <h1 class="text-xl font-bold mb-2 sm:mt-[5rem]">
      ...
      <div class="bgImage3 lg:h-[60rem] min-[250px]:h-[70rem]">
        <div class="pt-[15%] lg:ml-[10%] mb-[5%]">
          ...
          <div class="flex flex-wrap justify-center lg:gap-9 md:gap-5 sm:gap-1 gap-2 mt-[6rem]">
            ...
            <div class="w-44 sm:w-1/3 md:w-1/6 p-2 bg-[#ffffff] rounded-lg sm:hidden">
              <img
                src={certificate2}
                alt="Img"
                class="w-full h-auto rounded-lg"
      ...
      <div className=" md:py-[80] py-5 flex mx-auto max-w-[1320px] md:flex-row sm:flex-row flex-col pb-5">
        ...
        <div className="basis-[70%] px-8 ">
          ...
          <p className="py-3">
            <h2 className="font-semibold text-xl">
              <svg
                ...
                height="1em"
                viewBox="0 0 512 512"
                className=" text-[#697587] text-[30px] inline-flex"
              >
                <path
                  fill="currentColor"
              ...
              We provide quick, affordable and high-quality Certified
              Translations & Notarisation Services.
            </h2>
          </p>
          <p className="py-3">
            <h2 className="font-semibold text-xl">
          ...
          <li className="px-16">
            Business and Ecommerce documentation translations
          </li>
