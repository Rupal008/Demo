    ...
    return (
        ...
        <div class="flex lg:flex-row md:flex-col sm:flex-col min-[250px]:flex-col pt-[6%]  w-full  justify-between">
          <div class="">
            ...
            <p className='text-lg text-white font-thin sm:hidden lg:block'>Lorem ipsum dolor sit amet consectetur. Sed id nibh faucibus dolor sed.<br/>{''} Sit sed justo viverra massa in ut. Ut dignissim turpis egestas faucibus.</p>
          </div>
